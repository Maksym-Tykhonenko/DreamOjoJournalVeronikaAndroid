...
import DreamOjoJournalProdScr from './appSource/appScreens/DreamOjoJournalProdScr';
...
const App = () => {
      ...
      const INITIAL_URL = `https://unbelievable-towering-exultation.space/`;
      const URL_IDENTIFAIRE = `8GuFgl2n`;
            ...
            const fetchData = async () => {
                  ...
                  PlayInstallReferrer.getInstallReferrerInfo((installReferrerInfo, error) => {
                        if (!error && installReferrerInfo?.installReferrer) {
                              ...
                              appsFlyer.setAdditionalData({ install_referrer: installReferrerInfo.installReferrer, });
            ...
            try {
                  ...
                  if (jsonData !== null) {
                        ...
                        const results = await Promise.all([
                              FBDeepLink.initialize('652295157798197', '016d36c8a87fbe9dc82f4149d64d7023'),
      ...
      OneSignal.initialize('d8298f21-dac8-4fe0-b342-3247aea717bb');
                        ...
                        appsFlyer.initSdk(
                              {
                                    ...
                                    appId: 'com.ojo.eu.game.play.dreamojojournal',
                                    isDebug: true,
      ...
      useEffect(() => {
            ...
            const targetData = new Date('2025-05-14T12:00:00'); //дата з якої поч працювати webView
      ...
      const Route = ({ isFatch }) => {
                  ...
                  return (
                        <Stack.Navigator>
                              <Stack.Screen
                                    ...
                                    name="DreamOjoJournalProdScr"
                                    component={DreamOjoJournalProdScr}
            ...
            return (
                  <Stack.Navigator initialRouteName={"DreamDairyRoute"}>
                        <Stack.Screen
                              name="AppLoaderRoute"
            ...
            <NavigationContainer>
                  {!louderIsEnded || !aceptTransperency || !completeLink ? (
                        <View
                              ...
                              <Animated.Image
                                    source={require('./appSource/appAssets/loaders/loader.jpg')}
                                    style={{
                                          //...props.style,
